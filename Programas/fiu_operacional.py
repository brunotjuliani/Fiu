...
QsimsS.to_csv(f'../Simulacoes/{ano:04d}_{mes:02d}_{dia:02d}_00/sim_sac_{ano:04d}{mes:02d}{dia:02d}00.csv',
              index_label='datahora', float_format='%.3f',
              date_format='%Y-%m-%dT%H:%M:%S+00:00')
...
fig.update_layout(legend_title_text='Modelo Sacramento')
fig.update_layout(autosize=False,width=1200,height=675,margin=dict(l=30,r=30,b=10,t=10))
fig.write_image(f'../Simulacoes/{ano:04d}_{mes:02d}_{dia:02d}_00/fig_sac_{ano:04d}{mes:02d}{dia:02d}00.png')
...
anc_gr = q_atual_obs - q_atual_gr
QsimsGR += anc_gr
#Exporta série ancorada
QsimsGR.to_csv(f'../Simulacoes/{ano:04d}_{mes:02d}_{dia:02d}_00/sim_gr5_{ano:04d}{mes:02d}{dia:02d}00.csv',
              index_label='datahora', float_format='%.3f',
              date_format='%Y-%m-%dT%H:%M:%S+00:00')
...
fig.update_layout(legend_title_text='Modelo GR5i')
fig.update_layout(autosize=False,width=1200,height=675,margin=dict(l=30,r=30,b=10,t=10))
fig.write_image(f'../Simulacoes/{ano:04d}_{mes:02d}_{dia:02d}_00/fig_gr5i_{ano:04d}{mes:02d}{dia:02d}00.png')
