...
df_gr5 = pd.read_csv(f'../Simulacoes/{ano:04d}_{mes:02d}_{dia:02d}_00/sim_gr5_mod_{ano:04d}{mes:02d}{dia:02d}00.csv',
                     parse_dates=True, index_col='datahora')
...
## LATEX BOLETIM
script = open('../Boletim/boletim_mod.tex','w')
script.write(f'''
...
\\begin{{figure}}[ht]
    \\centering
    \\vspace{{-24pt}}
    \\includegraphics[width=\\textwidth]{{fig_sac_mod_{ano:04d}{mes:02d}{dia:02d}00.png}}
...
\\begin{{figure}}[ht]
    \\centering
    \\vspace{{-24pt}}
    \\includegraphics[width=\\textwidth]{{fig_gr5i_mod_{ano:04d}{mes:02d}{dia:02d}00.png}}
...
## PREPARA PDF
os.chdir("../Boletim")
os.system(f'scp -r ../Simulacoes/{ano:04d}_{mes:02d}_{dia:02d}_00/fig_sac_mod_{ano:04d}{mes:02d}{dia:02d}00.png .')
os.system(f'scp -r ../Simulacoes/{ano:04d}_{mes:02d}_{dia:02d}_00/fig_gr5i_mod_{ano:04d}{mes:02d}{dia:02d}00.png .')
